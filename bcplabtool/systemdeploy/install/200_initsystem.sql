...
(8, 0, 'sms', 'group', '', '', '', '1'),
(9, 0, 'wap', 'group', '', '', '', '1'),
(101, 1, 'shop_name', 'text', '', '', '科网商城', '1'),
(102, 1, 'shop_title', 'text', '', '', '欢迎光临科网商城', '1'),
(103, 1, 'shop_desc', 'text', '', '', '科网商城，助力科研', '1'),
...
(601, 6, 'integrate_code', 'hidden', '', '', 'bcplab', '1'),
...
INSERT INTO `ecs_user_rank` (`rank_id`, `rank_name`, `min_points`, `max_points`, `discount`, `show_price`, `special_rank`) VALUES
 (1, '注册用户', 0, 1000, 100, 1, 0),
 (2, '铁牌用户', 1000, 10000, 99, 1, 0),
 (3, '铜牌用户', 10000, 100000, 98, 1, 0),
 (4, '银牌用户', 100000, 200000, 97, 1, 0),
 (5, '金牌用户',  200000, 2000000000, 96, 1, 0),
 (6, '经销商', 0, 2000000000, 90, 1, 1),
 (7, '特约经销商', 0, 2000000000, 85, 1, 1);
