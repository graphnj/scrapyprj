...
drop database if exists bcplab;
create database bcplab CHARSET=utf8;
use bcplab;
--
-- 表的结构 `ecs_ad`
--
...
CREATE TABLE `ecs_goods` (
  ...
  `chem_specification` varchar(100) default NULL,
  `chem_specification_id` varchar(100) default NULL,   -- ecs_reagent_specifications.id
...
CREATE TABLE `ecs_member_price` (
  ...
  `user_discount` decimal(5,2) NOT NULL default '1.00',
...
CREATE TABLE `ecs_user_rank` (
  `rank_id` tinyint(5) unsigned NOT NULL auto_increment,
...
CREATE TABLE `ecs_relation_request` (
  `boss_id` mediumint(8) unsigned NOT NULL default '0',
  `sub_id` mediumint(8) unsigned NOT NULL default '0',
  `accepted` tinyint(1) unsigned NOT NULL default '0',
  `req_time` int(11) unsigned NOT NULL default '0',
  PRIMARY KEY  (`boss_id`,`sub_id`),
  KEY(`boss_id`),
  KEY(`sub_id`)
) ENGINE=MyISAM;
...
CREATE TABLE `ecs_suppliers` (
  ...
  `suppliers_name` varchar(60) NOT NULL default '',
  `suppliers_desc` varchar(255) NOT NULL default '',
  `suppliers_url` varchar(255) NOT NULL default '',
  `suppliers_contact` varchar(20) NOT NULL default '',
  `suppliers_tele` varchar(20) NOT NULL default '',
  `suppliers_email` varchar(60) NOT NULL default '',
  `suppliers_license` varchar(600) NOT NULL default '',
  `suppliers_origin` varchar(30) NOT NULL default '',
  `suppliers_admin` smallint(5) unsigned NOT NULL default 1, 
  `is_show` tinyint( 1 ) unsigned NOT NULL default '1',
...
DROP TABLE IF EXISTS `ecs_suppliers_brand_rel`;
CREATE TABLE `ecs_suppliers_brand_rel` (
  `suppliers_id` smallint(5) unsigned NOT NULL auto_increment,
  `brand_id` smallint(5) unsigned NOT NULL,
  PRIMARY KEY  (`suppliers_id`,`brand_id`)
  );
...
CREATE TABLE `ecs_brand` (
  ...
  `brand_origin` varchar(30) NOT NULL default '',
  `brand_cycle` tinyint(3) unsigned NOT NULL default '5',
...
DROP TABLE IF EXISTS `ecs_requirement`;
CREATE TABLE `ecs_requirement` (
  `req_id`     int(10) unsigned NOT NULL auto_increment,
  `user_id`    int(10) NULL default 0,
  `req_cnName` varchar(30) NOT NULL default '',
  `req_enName` varchar(30) NULL default '',
  `req_catLevel1` int(10) NULL default 0,
  `req_catLevel2` int(10) NULL default 0,
  `req_catLevel3` int(10) NULL default 0,
  `req_catLevel4` int(10) NULL default 0,
  `req_brand`  varchar(30) NULL default '',
  `req_goodssn` varchar(30) NULL default '',
  `req_cas`     varchar(30) NULL default '',
  `req_spec`    varchar(30) NULL default '',
  `req_wrap`    varchar(30) NULL default '',
  `req_refurl`  varchar(30) NULL default '',
  `req_desc`    varchar(300) NULL default '',
  `req_attach`  varchar(30) NULL default '',
  `req_qq`      varchar(30) NULL default '',
  `req_mobile`  varchar(30) NOT NULL default '',
